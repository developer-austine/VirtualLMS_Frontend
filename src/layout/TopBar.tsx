  ...
  return (
    <div className="bg-[#1a2a5e] text-white text-sm py-2 px-6 flex items-center justify-between">
      <div className="flex items-center gap-6">
        ...
        <a href="mailto:elearning@kcau.ac.ke" className="flex items-center gap-2 hover:text-[#c9a227] transition-colors duration-200">
          <Mail size={14} />
          <span>E-mail : elearning@kcau.ac.ke</span>
        </a>
      </div>

      {/* Hide Log in when authenticated — icons show in Navbar instead */}
      {!isAuthenticated && (
