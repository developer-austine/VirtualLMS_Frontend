...
const Navbar = () => {
  ...
  const navLinks = !isAuthenticated ? [] : role === "lecturer" ? lecturerLinks : studentLinks;
  ...
  return (
    <nav className="sticky top-0 z-50 bg-[#c9a227] shadow-md">
      <div className="w-full px-6 py-3 flex items-center justify-between">
        ...
        {/* Mobile toggle */}
        <button className="md:hidden text-[#1a2a5e] bg-white/30 p-2 rounded" onClick={() => setMobileOpen(!mobileOpen)}>
